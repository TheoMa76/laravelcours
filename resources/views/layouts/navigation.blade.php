<nav x-data="{ open: false }" class="bg-white w-full flex flex-row items-center border-b border-[var(--primary-gray-light)] drop-shadow-lg h-24">
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between">
            <div class="flex">
                <!-- Logo -->
                <div class="flex items-center w-fit mx-10">
